...
export const Chatbot: React.FC = () => {
  const [messages, setMessages] = useState<Array<{ role: 'user' | 'assistant'; content: string; timestamp: Date }>>([
    {
      role: 'assistant',
      content: 'Hello! I\'m your F43 Materials Science Assistant. How can I help you today?',
      timestamp: new Date(),
    },
  ]);
  ...
  const generateResponse = (userInput: string) => {
    ...
    if (lowercaseInput.includes('titanium') || lowercaseInput.includes('ti')) {
      ...
      response = 'Hello! I\'m your materials science assistant. Feel free to ask me about elements, materials, properties, or engineering applications.';
    } else {
